...
The user updates their installed copy from the trace folder with
`pnpm update-app` (`-Check` previews), and tells builds apart by version. So a PR that changes what the app does runs
